                    ...
                    <div class="flex items-center space-x-3 flex-1">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-700">
                                ...
                                experiência. Ao continuar navegando, você
                                concorda com nossa
                                <button
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <p class="text-gray-700 mb-4">
                            O GoDeliveryPro utiliza cookies para melhorar sua
                            experiência, personalizar conteúdo e analisar nosso
                            tráfego. Você pode escolher quais tipos de cookies
                            aceitar.
                        </p>
                                ...
                                >
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">
                                                Nos ajudam a entender como você
                                                usa nosso site
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        >
                                            <div
                                                class="w-4 h-4 bg-white rounded-full mx-1"
                                            ></div>
                                        </button>
                                    </div>
                                </div>
                                ...
                                >
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">
                                                Para lembrar suas preferências e
                                                configurações
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-sm text-blue-800">
                                    <strong>Importante:</strong> Você pode
                                    alterar suas preferências a qualquer momento
                                    nas configurações do seu navegador ou
                                    clicando no link "Cookies" no rodapé do
                                    site.
                                </p>
                                <p class="text-xs text-blue-700 mt-2">
                                    ⏱️ As preferências de cookies expiram
...
onMounted(() => {
    ...
    if (!savedPreferences) {
        ...
        if (preferences.timestamp && isCookieExpired(preferences.timestamp)) {
            ...
            showBanner.value = true;
            console.log(
                "Cookie expirado após 5 minutos. Removendo preferências."
            );
        } else {
